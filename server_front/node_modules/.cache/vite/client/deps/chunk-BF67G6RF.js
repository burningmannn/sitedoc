...
import { resolveComponent, createElementBlock as createElementBlock2, openBlock as openBlock2, mergeProps as mergeProps2, createElementVNode as createElementVNode2, renderSlot, normalizeClass, createBlock, createCommentVNode } from "vue";
var script$1 = {
  name: "BaseCheckbox",
  "extends": script3,
  props: {
...
function render2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock2(), createElementBlock2("div", mergeProps2({
  ...
  }), [createElementVNode2("input", mergeProps2({
    id: _ctx.inputId,
    type: "checkbox",
  ...
  }, $options.getPTOptions("input")), null, 16, _hoisted_2), createElementVNode2("div", mergeProps2({
    "class": _ctx.cx("box")
    ...
    return [$options.checked ? (openBlock2(), createBlock(_component_CheckIcon, mergeProps2({
      key: 0,
      "class": _ctx.cx("icon")
    }, $options.getPTOptions("icon"), {
      "data-p": $options.dataP
    }), null, 16, ["class", "data-p"])) : $data.d_indeterminate ? (openBlock2(), createBlock(_component_MinusIcon, mergeProps2({
      key: 1,
      "class": _ctx.cx("icon")
    }, $options.getPTOptions("icon"), {
      "data-p": $options.dataP
...
//# sourceMappingURL=chunk-BF67G6RF.js.map
