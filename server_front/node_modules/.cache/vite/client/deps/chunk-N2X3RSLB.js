...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d = T2 || {}, { colorScheme: M2 } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), h2 = M2 || {}, { dark: te } = h2, re = v2(h2, ["dark"]), K2 = s(O2) ? this._toVariables({ [y2]: g2(g2({}, O2), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: g2(g2({}, L), re) }, r) : {}, X = s(V2) ? this._toVariables({ [y2]: g2(g2({}, V2), te) }, r) : {}, [G3, U3] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H, W2] = [(p3 = X.declarations) != null ? p3 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G3}${B2}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H, "dark", "variable", r, i2, a2, n);
...
//# sourceMappingURL=chunk-N2X3RSLB.js.map
