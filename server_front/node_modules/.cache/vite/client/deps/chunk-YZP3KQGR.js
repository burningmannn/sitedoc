...
function D(t2, e, o = true) {
  var n, r, i2, l;
  if (t2) {
    let d = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), s4 = d.height, a2 = d.width, u = e.offsetHeight, c = e.offsetWidth, f2 = e.getBoundingClientRect(), g3 = $(), it = k(), lt = h(), L, N2, ot = "top";
    f2.top + u + s4 > lt.height ? (L = f2.top + g3 - s4, ot = "bottom", L < 0 && (L = g3)) : L = u + f2.top + g3, f2.left + a2 > lt.width ? N2 = Math.max(0, f2.left + it + c - a2) : N2 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N2 + "px" : t2.style.insetInlineStart = N2 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l = (i2 = x(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l : "");
  }
}
function S(t2, e) {
...
function At(t2) {
  ...
  if (t2) {
    let o = M(t2), n = /(auto|scroll)/, r = (i2) => {
      try {
        let l = window.getComputedStyle(i2, null);
    ...
    for (let i2 of o) {
      let l = i2.nodeType === 1 && i2.dataset.scrollselectors;
      if (l) {
        let d = l.split(",");
        for (let s4 of d) {
          let a2 = z2(i2, s4);
...
function g() {
  ...
  }, a2 = (e, n) => u(e, n).value, u = (e, n, t2 = 0) => [...r].reverse().find((s4) => n ? true : s4.key === e) || { key: e, value: t2 }, l = (e) => e && parseInt(e.style.zIndex, 10) || 0;
  return { get: l, set: (e, n, t2) => {
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let h2 = m2[u], f2 = ve(h2), p3 = z(u, a2) ? Q2(d) : Q2(d, ee(u));
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s2(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j } = m2, O2 = v2(m2, ["colorScheme", "extend", "css"]), d = T2 || {}, { colorScheme: M2 } = d, z3 = v2(d, ["colorScheme"]), u = R2 || {}, { dark: V2 } = u, L = v2(u, ["dark"]), h2 = M2 || {}, { dark: te } = h2, re = v2(h2, ["dark"]), K2 = s2(O2) ? this._toVariables({ [y2]: g2(g2({}, O2), z3) }, r) : {}, A2 = s2(L) ? this._toVariables({ [y2]: g2(g2({}, L), re) }, r) : {}, X = s2(V2) ? this._toVariables({ [y2]: g2(g2({}, V2), te) }, r) : {}, [G3, U3] = [(f2 = K2.declarations) != null ? f2 : "", K2.tokens || []], [B2, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H, W2] = [(p3 = X.declarations) != null ? p3 : "", X.tokens || []], q2 = this.transformCSS(y2, `${G3}${B2}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H, "dark", "variable", r, i2, a2, n);
    l = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U3, ...I2, ...W2])], c = m(j, { dt: E2 });
  }
  ...
  let a2 = function(l, o = {}, c = []) {
    ...
    Object.entries(l).forEach(([m2, d]) => {
      ...
      i(d) ? n(d, u, h2) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x3 = {}, p3 = []) => {
        ...
        return i2[u].paths.map((y2) => y2.computed(y2.scheme, x3[y2.scheme], p3));
  ...
  if (s2(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c.reduce((m2, { type: d, selector: u }) => (s2(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l, d, t2)), m2), "") : C2(l != null ? l : ":root", t2);
    }
    if (o) {
...
function _iterableToArrayLimit(r, l) {
  ...
  if (null != t2) {
    ...
    try {
      ...
      else for (; !(f2 = (e = i2.call(t2)).done) && (a2.push(e.value), a2.length !== l); f2 = true) ;
    } catch (r2) {
      o = true, n = r2;
    } finally {
      try {
...
//# sourceMappingURL=chunk-YZP3KQGR.js.map
