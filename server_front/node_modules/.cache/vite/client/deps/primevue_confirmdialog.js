...
} from "./chunk-SBO6O7K7.js";
import {
  blockBodyScroll,
  unblockBodyScroll
} from "./chunk-IBAKGTPX.js";
import {
  FocusTrap
...
import "./chunk-TCLWDSVZ.js";
import "./chunk-HRK7K64L.js";
import {
  script
...
import { computed, resolveComponent, resolveDirective, createBlock, openBlock as openBlock3, withCtx, createElementBlock as createElementBlock3, createCommentVNode, mergeProps as mergeProps3, createVNode, Transition, withDirectives, renderSlot, Fragment, createElementVNode as createElementVNode3, normalizeClass, toDisplayString, resolveDynamicComponent, createTextVNode } from "vue";
    ...
    "default": withCtx(function() {
      return [$data.containerVisible ? (openBlock3(), createElementBlock3("div", mergeProps3({
        ...
        "default": withCtx(function() {
          ...
          }) : createCommentVNode("", true)], 16)], 16)) : createCommentVNode("", true), createElementVNode3("div", mergeProps3({
            ref: $options.contentRef,
            "class": [_ctx.cx("content"), _ctx.contentClass],
            style: _ctx.contentStyle,
            "data-p": $options.dataP
          }, _objectSpread(_objectSpread({}, _ctx.contentProps), _ctx.ptm("content"))), [renderSlot(_ctx.$slots, "default")], 16, _hoisted_4), _ctx.footer || _ctx.$slots.footer ? (openBlock3(), createElementBlock3("div", mergeProps3({
            key: 1,
...
import { resolveComponent as resolveComponent2, createBlock as createBlock2, openBlock as openBlock4, normalizeClass as normalizeClass2, createSlots, withCtx as withCtx2, createElementBlock as createElementBlock4, createCommentVNode as createCommentVNode2, Fragment as Fragment2, renderSlot as renderSlot2, createElementVNode as createElementVNode4, resolveDynamicComponent as resolveDynamicComponent2, mergeProps as mergeProps4, toDisplayString as toDisplayString2, createVNode as createVNode2 } from "vue";
var script$12 = {
...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  var _component_Button = resolveComponent2("Button");
  var _component_Dialog = resolveComponent2("Dialog");
  return openBlock4(), createBlock2(_component_Dialog, {
    visible: $data.visible,
    "onUpdate:visible": [_cache[2] || (_cache[2] = function($event) {
      return $data.visible = $event;
    }), $options.onHide],
    role: "alertdialog",
    "class": normalizeClass2(_ctx.cx("root")),
    modal: $options.modal,
    ...
    "default": withCtx2(function() {
      return [!_ctx.$slots.container ? (openBlock4(), createElementBlock4(Fragment2, {
        key: 0
      }, [!_ctx.$slots.message ? (openBlock4(), createElementBlock4(Fragment2, {
        key: 0
      }, [renderSlot2(_ctx.$slots, "icon", {}, function() {
        return [_ctx.$slots.icon ? (openBlock4(), createBlock2(resolveDynamicComponent2(_ctx.$slots.icon), {
          key: 0,
          "class": normalizeClass2(_ctx.cx("icon"))
        }, null, 8, ["class"])) : $data.confirmation.icon ? (openBlock4(), createElementBlock4("span", mergeProps4({
          key: 1,
          "class": [$data.confirmation.icon, _ctx.cx("icon")]
        }, _ctx.ptm("icon")), null, 16)) : createCommentVNode2("", true)];
      }), createElementVNode4("span", mergeProps4({
        "class": _ctx.cx("message")
      }, _ctx.ptm("message")), toDisplayString2($options.message), 17)], 64)) : (openBlock4(), createBlock2(resolveDynamicComponent2(_ctx.$slots.message), {
        key: 1,
        message: $data.confirmation
      }, null, 8, ["message"]))], 64)) : createCommentVNode2("", true)];
    }),
    _: 2
  }, [_ctx.$slots.container ? {
    name: "container",
    fn: withCtx2(function(slotProps) {
      return [renderSlot2(_ctx.$slots, "container", {
        message: $data.confirmation,
    ...
    fn: withCtx2(function() {
      ...
      return [createVNode2(_component_Button, mergeProps4({
        ...
        name: "icon",
        fn: withCtx2(function(iconProps) {
          return [renderSlot2(_ctx.$slots, "rejecticon", {}, function() {
        ...
        key: "0"
      } : void 0]), 1040, ["class", "autofocus", "unstyled", "text", "label", "pt"]), createVNode2(_component_Button, mergeProps4({
        ...
        name: "icon",
        fn: withCtx2(function(iconProps) {
          return [renderSlot2(_ctx.$slots, "accepticon", {}, function() {
            return [createElementVNode4("span", mergeProps4({
