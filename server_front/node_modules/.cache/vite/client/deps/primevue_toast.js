...
import { resolveDirective, createElementBlock as createElementBlock4, openBlock as openBlock4, mergeProps as mergeProps4, createBlock, resolveDynamicComponent, createCommentVNode, Fragment, createElementVNode as createElementVNode4, toDisplayString, normalizeProps, withDirectives, resolveComponent, withCtx, createVNode, TransitionGroup, renderList } from "vue";
var script$2 = {
  name: "BaseToast",
  "extends": script,
  props: {
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock4(), createElementBlock4("div", mergeProps4({
  ...
  }), [$props.templates.container ? (openBlock4(), createBlock(resolveDynamicComponent($props.templates.container), {
    key: 0,
    message: $props.message,
    closeCallback: $options.onCloseClick
  }, null, 8, ["message", "closeCallback"])) : (openBlock4(), createElementBlock4("div", mergeProps4({
    key: 1,
    "class": [_ctx.cx("messageContent"), $props.message.contentStyleClass]
  }, _ctx.ptm("messageContent")), [!$props.templates.message ? (openBlock4(), createElementBlock4(Fragment, {
    key: 0
  }, [(openBlock4(), createBlock(resolveDynamicComponent($props.templates.messageicon ? $props.templates.messageicon : $props.templates.icon ? $props.templates.icon : $options.iconComponent && $options.iconComponent.name ? $options.iconComponent : "span"), mergeProps4({
    "class": _ctx.cx("messageIcon")
  }, _ctx.ptm("messageIcon")), null, 16, ["class"])), createElementVNode4("div", mergeProps4({
    "class": _ctx.cx("messageText"),
    "data-p": $options.dataP
  }, _ctx.ptm("messageText")), [createElementVNode4("span", mergeProps4({
    "class": _ctx.cx("summary"),
    "data-p": $options.dataP
  }, _ctx.ptm("summary")), toDisplayString($props.message.summary), 17, _hoisted_3), $props.message.detail ? (openBlock4(), createElementBlock4("div", mergeProps4({
    key: 0,
    "class": _ctx.cx("detail"),
    "data-p": $options.dataP
  }, _ctx.ptm("detail")), toDisplayString($props.message.detail), 17, _hoisted_4)) : createCommentVNode("", true)], 16, _hoisted_2)], 64)) : (openBlock4(), createBlock(resolveDynamicComponent($props.templates.message), {
    key: 1,
    message: $props.message
    ...
    autofocus: "",
    "data-p": $options.dataP
  }, _objectSpread$1(_objectSpread$1({}, $props.closeButtonProps), _ctx.ptm("closeButton"))), [(openBlock4(), createBlock(resolveDynamicComponent($props.templates.closeicon || "TimesIcon"), mergeProps4({
